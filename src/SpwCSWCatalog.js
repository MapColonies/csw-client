define([
  ...
  return declare(
    ...
    [Stateful],
    /** @lends spw.api.SpwCSWCatalog.prototype */ {
      /**
          ...
          .then(
            lang.hitch(this, function (resp) {
              ...
              var tmp = {
                ...
                records: array.map(
                  records,
                  lang.hitch(this, function (r, idx) {
                    var newRecord = {};
      ...
      _getCatalogServiceConfig: function (id) {
        ...
        array.some(
          catalog,
          lang.hitch(this, function (serviceGroup) {
        ...
        this.protocols = [
          {
            ...
            config: {
              // la config du service correspondant à ce protocol
              type: 'AGS_DYNAMIC',
              hasLegend: true,
              alpha: 100,
              toLoad: true,
